...
function updateStats() {
  ...
  const total_recovered = recovered_list.filter((nc)=>{return nc>0}).reverse()[0];
  const new_recovered_cases = total_recovered - recovered_list.filter((nc)=>{return nc>0}).reverse()[1];;
